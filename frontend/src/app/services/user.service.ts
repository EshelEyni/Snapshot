  ...
  public async toggleFollow(
    ...
    if (isFollowing) {
      await firstValueFrom(
        this.http.delete(`${this.baseUrl}/following`, {
          body: { followerId: loggedinUser.id, userId: user.id },
        }),
      )
      await firstValueFrom(
        this.http.delete(`${this.baseUrl}/followers`, {
          body: { followingId: user.id, userId: loggedinUser.id },
        }),
      )
    } else {
      const following = {
      ...
      await firstValueFrom(
        this.http.post(`${this.baseUrl}/following`, following),
      )
      ...
      await firstValueFrom(
        this.http.post(`${this.baseUrl}/followers`, follower),
      )
    }
  }
}
